...
import 'package:say_hi/widget/app_button.dart';
import 'package:say_hi/widget/hi_emoji.dart';
import 'package:say_hi/widget/phone_input.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Say Hii")),
      body: ListView(
        children: [
          Padding(
